...
document.addEventListener('DOMContentLoaded', function() {
  var checkedRadios = document.querySelectorAll('input[data-option-radio]:checked');
  checkedRadios.forEach(function(radio) {
    var value = radio.value;
    var name = radio.name;
    var spans = document.querySelectorAll('.option__name-wrap--' + name);
...
document.addEventListener('change', function(event) {
  ...
  if (target.matches('input[data-option-radio]:checked')) {
